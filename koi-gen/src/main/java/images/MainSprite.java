...
public class MainSprite {
    ...
    public boolean isFull() {
        return topImages.size()==2 && botImages.size() == 2;
    }
    ...
    public BufferedImage getImage(CharSide side) {
        ...
        if (topImage==null) topImage = Utils.createRedImage(8,4);
        BufferedImage botImage = botImages.get(side);
        if (botImage==null) botImage = Utils.createRedImage(8,4);
